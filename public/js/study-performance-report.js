...
function boot(){
  ...
  if(window.StudyPerformanceReport){load('./js/study-performance-report-v2.js?rev=20260822-5','data-study-report-v2');return;}
  load('./js/study-performance-report-core.js?rev=20260822-5','data-study-report-core',()=>load('./js/study-performance-report-v2.js?rev=20260822-5','data-study-report-v2'));
}
